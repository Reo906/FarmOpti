...
function DetailView({ view, disrupted, onNavigate, onOpenUpload, historyStatus, onOutputChange }: { view: ViewKey; disrupted: boolean; onNavigate: (view: ViewKey) => void; onOpenUpload: () => void; historyStatus?: string; onOutputChange: (next: OptimizerOutput) => void }) {
