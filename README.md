...
The app is a React/TypeScript site at the repo root:

```
app/                       Next.js app router (layout + page -> YallambeeDashboard)
components/
  YallambeeDashboard.tsx   Top-level UI component — live dashboard over the optimizer's output
   ui/                      shadcn component library (table, badge, etc.)
lib/optimizer/             TypeScript optimization pipeline + chatbot (see OPTIMISATION_README.md
                            and FARMOPTI_DECISION_TO_LLM_README.md under data/)
```
