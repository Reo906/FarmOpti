...
```text
app/lib/optimizer/decisionAnalysis/extractDecisions.ts
```
...
```text
app/lib/optimizer/decisionAnalysis/analyseCounterfactuals.ts
```
...
```text
app/lib/optimizer/decisionAnalysis/buildDecisionIndex.ts
```
...
```text
app/lib/optimizer/chatbot/explanationService.ts
```
...
```text
app/lib/optimizer/chatbot/retrieveDecisions.ts
```
...
```text
app/lib/optimizer/chatbot/scenario/validator.ts
```
...
```text
app/lib/optimizer/chatbot/scenario/runner.ts
```
...
```text
app/lib/optimizer/chatbot/scenario/comparator.ts
```
